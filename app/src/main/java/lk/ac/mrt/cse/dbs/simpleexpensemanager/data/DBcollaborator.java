...
public class DBcollaborator extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 3;
    private static final String DATABASE_NAME = "170205A";
...
//  keys
    ...
    public static DBcollaborator instance;

    public static DBcollaborator getInstance(Context context) {
        if (instance == null) {
            instance = new DBcollaborator(context);
        }
        return instance;
    };
    ...
    public DBcollaborator(@Nullable Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
        //  if pervious table existed drop it
