...
import lk.ac.mrt.cse.dbs.simpleexpensemanager.control.DataBaseExpenseManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBcollaborator db = DBcollaborator.getInstance(this);
...
//        expenseManager = new InMemoryDemoExpenseManager();
        expenseManager = new DataBaseExpenseManager(db);
        /*** END ***/
    }
